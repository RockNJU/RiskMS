...
<div class="am-cf admin-main">
  <!-- sidebar start -->
    ...
    <div class="am-offcanvas-bar admin-offcanvas-bar">
      <ul class="am-list admin-sidebar-list">
        <li><a href="../admin/showAllRiskItemForDeveloper"><span class="am-icon-home"></span> 风险条目查看</a></li>
  ...
  <div class="admin-content">		
	<div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">风险条目查看</strong> <small></small></div>
    </div>
    
<div class="am-tabs am-margin" data-am-tabs>
    <ul class="am-tabs-nav am-nav am-nav-tabs">
      <li class="am-active"><a href="#tab1">被分配风险条目</a></li>
     ...
     <div class="am-tabs-bd">
      ...
      <th style="background: #C2F1E2">查看风险状态</th>
           ...
           <s:iterator id="s" value="riskItemListOfCurrentUser" status="scdsStatus">
     <tr>
       ...
       <s:set var="riskItem" value="#s" scope="session"></s:set>
		  ...
		  <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                    <s:url action="showItemStateListModify" var="p">
     ...
     <tr>
       ...
       <s:set var="riskItem" value="#s" scope="session"></s:set>
		  ...
		  <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                    <s:url action="showItemStateListShow" var="p">
			    <s:param name="riskItemId"><s:property  value="riskItem_id"/></s:param>
			</s:url>
                    <s:a href="%{p}" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span>查看</s:a>
